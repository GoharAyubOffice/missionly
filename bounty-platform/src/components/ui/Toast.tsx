...
const toastVariants = {
  success: {
    ...
    colors: 'bg-white border-l-4 border-success text-success-dark',
  ...
  error: {
    ...
    colors: 'bg-white border-l-4 border-error text-error-dark',
  ...
  warning: {
    ...
    colors: 'bg-white border-l-4 border-warning text-warning-dark',
  ...
  info: {
    ...
    colors: 'bg-white border-l-4 border-info text-info-dark',
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          exit="exit"
          className={cn(
            'relative flex items-start p-4 rounded-lg shadow-lg max-w-sm w-full',
            variant.colors
          )}
        >
          <div className={cn(
